...
/**
 * Register a custom post type called "locations".
 *
 * @see get_post_type_labels() for label keys.
 */
function test_create_post_type2() {
    $labels = array(
        'name'                  => _x( 'Locations', 'Post type general name', 'textdomain' ),
        'singular_name'         => _x( 'Locations', 'Post type singular name', 'textdomain' ),
        'menu_name'             => _x( 'Locations', 'Admin Menu text', 'textdomain' ),
        'name_admin_bar'        => _x( 'Locations', 'Add New on Toolbar', 'textdomain' ),
        'add_new'               => __( 'Add New', 'textdomain' ),
        'add_new_item'          => __( 'Add New Locations', 'textdomain' ),
        'new_item'              => __( 'New Locations', 'textdomain' ),
        'edit_item'             => __( 'Edit Locations', 'textdomain' ),
        'view_item'             => __( 'View Locations', 'textdomain' ),
        ...
        'featured_image'        => _x( 'Locations Cover Image', 'Overrides the “Featured Image” phrase for this post type. Added in 4.3', 'textdomain' ),
        'set_featured_image'    => _x( 'Set cover image', 'Overrides the “Set featured image” phrase for this post type. Added in 4.3', 'textdomain' ),
        'remove_featured_image' => _x( 'Remove cover image', 'Overrides the “Remove featured image” phrase for this post type. Added in 4.3', 'textdomain' ),
        'use_featured_image'    => _x( 'Use as cover image', 'Overrides the “Use as featured image” phrase for this post type. Added in 4.3', 'textdomain' ),
        'archives'              => _x( 'Locations archives', 'The post type archive label used in nav menus. Default “Post Archives”. Added in 4.4', 'textdomain' ),
        'insert_into_item'      => _x( 'Insert into Locations', 'Overrides the “Insert into post”/”Insert into page” phrase (used when inserting media into a post). Added in 4.4', 'textdomain' ),
        'uploaded_to_this_item' => _x( 'Uploaded to this Locations', 'Overrides the “Uploaded to this post”/”Uploaded to this page” phrase (used when viewing media attached to a post). Added in 4.4', 'textdomain' ),
...
add_action( 'init', 'test_create_post_type2' );
